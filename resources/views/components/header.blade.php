            ...
            <nav class="bg-pink-500 border-gray-200 px-4 lg:px-6 py-2.5 text-white">
                <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <a href="https://flowbite.com" class="flex items-center">
                        <img src="https://cdn-icons-png.flaticon.com/512/8262/8262475.png" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
                        <span class="self-center text-xl font-semibold whitespace-nowrap">Arjuno Travel</span>
                    </a>
                    <div class="flex items-center lg:order-2">
                        <a href="/api/documentation" class="hover:bg-sky-500 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 focus:outline-none ">Log in</a>
                        <a href="/api/documentation" class="hover:bg-sky-500 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2">Get started</a>
                    ...
                    <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                        <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            <li>
                                <a href="/api/documentation" class="block py-2 pr-4 pl-3 text-white rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0" aria-current="page">Beranda</a>
                            </li>
                            <li>
